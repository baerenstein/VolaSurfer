...
def update_surface(frame, ax, spot, model, params):
    ax.clear()
    strikes = np.linspace(spot * 0.6, spot * 1.4, 10)  # Wider range of strikes
    maturities = np.linspace(1/12, 1/2, 10)  # Maturities from 1 month to 2 years
    ...
    ax.view_init(elev=25, azim=45)   # Set the viewing angle
